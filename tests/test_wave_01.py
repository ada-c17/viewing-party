...
def test_moves_movie_from_watchlist_to_watched():
    ...
    watchedMovies = updated_data["watched"]
    secondWatchedMovie = watchedMovies[1]
    secondWatchedMovieTitle = secondWatchedMovie["title"]

    horror1Title = HORROR_1["title"]

    assert horror1Title is secondWatchedMovieTitle
