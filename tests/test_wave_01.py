import pytest
# NOTE: In production code, we developers should change import * to something more specific. Due to some constraints of th==project, we will import * in our test files.
...
def test_moves_movie_from_watchlist_to_watched():
    ...
    assert FANTASY_2 in janes_data["watched"]
